...
design2 = Design.create(user_id: wayne.id, creator_id: wayne.id, title: "Facebook cover photo", description: "idea for Facebook stuff", public: false, width: 820, height: 312)
